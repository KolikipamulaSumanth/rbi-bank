...
public interface AccountRepository extends JpaRepository<Account, String> {
    ...
    Optional<Account> findFirstByCodeAndOwnerUid(String code, String uid);
    ...
    List<Account> findByAccountNameContainingIgnoreCaseOrOwnerPanNumberContainingIgnoreCaseOrOwnerTel(
        String accountName,
        String panNumber,
        long tel
    );
